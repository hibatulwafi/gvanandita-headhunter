    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-100 p-6">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden w-full max-w-4xl p-8">
            ...
            <div class="flex flex-col justify-center">
                <h2 class="text-3xl font-bold text-gray-800 mb-2 text-center">Buat Akun Baru</h2>
                ...
                <div class="flex items-center justify-between md:justify-around mb-8 text-center">
                    <div class="flex-1 flex flex-col items-center">
                        <div :class="{ 'bg-indigo-600 text-white': step === 1, 'bg-gray-300 text-gray-600': step !== 1 }"
                            class="w-8 h-8 rounded-full flex items-center justify-center font-bold">1</div>
                        <div :class="{ 'text-indigo-600 font-bold': step === 1, 'text-gray-400': step !== 1 }"
                            class="text-sm md:text-lg mt-2 hidden md:block">
                            Data Pribadi
                        </div>
                    </div>
                    <div class="flex-1 flex flex-col items-center">
                        <div :class="{ 'bg-indigo-600 text-white': step === 2, 'bg-gray-300 text-gray-600': step !== 2 }"
                            class="w-8 h-8 rounded-full flex items-center justify-center font-bold">2</div>
                        <div :class="{ 'text-indigo-600 font-bold': step === 2, 'text-gray-400': step !== 2 }"
                            class="text-sm md:text-lg mt-2 hidden md:block">
                            Pengalaman Kerja
                        </div>
                    </div>
                    <div class="flex-1 flex flex-col items-center">
                        <div :class="{ 'bg-indigo-600 text-white': step === 3, 'bg-gray-300 text-gray-600': step !== 3 }"
                            class="w-8 h-8 rounded-full flex items-center justify-center font-bold">3</div>
                        <div :class="{ 'text-indigo-600 font-bold': step === 3, 'text-gray-400': step !== 3 }"
                            class="text-sm md:text-lg mt-2 hidden md:block">
                            Profil Karir
                        </div>
                    </div>
                ...
                <form @submit.prevent="handleSubmit" class="space-y-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" @click="showPassword = !showPassword"
                                    class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-indigo-600 focus:outline-none">
                    ...
                    <div class="flex justify-between">
                        ...
                        <button type="button" @click="step++" v-if="step < 3"
                            class="bg-indigo-600 text-white py-2 px-6 rounded-xl font-semibold hover:bg-indigo-700 transition duration-200">
                            Selanjutnya
                        </button>
                ...
                <p class="text-center text-gray-500 text-sm mt-6">
                    Sudah punya akun?
                    <a href="#" class="text-indigo-600 font-medium hover:underline">Masuk</a>
                </p>
            </div>
        </div>
    </div>
