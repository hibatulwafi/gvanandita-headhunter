  ...
  <div class="min-h-screen bg-gray-100 p-6 flex justify-center">
    <div class="bg-white rounded-3xl shadow-2xl max-w-4xl w-full p-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <!-- Professional Info -->
        <div class="bg-gray-50 p-6 rounded-xl shadow-sm relative transition-transform duration-500 hover:scale-[1.02]"
        ...
        <div class="bg-gray-50 p-6 rounded-xl shadow-sm relative transition-transform duration-500 hover:scale-[1.02]"
          ...
          <div class="grid grid-cols-[140px_1fr] gap-x-4 gap-y-2 text-sm">
            ...
            <span>
              <a :href="authStore.user.resume_path" target="_blank"
                class="text-orange-500 hover:underline hover:scale-105 transition-transform duration-300 text-sm">Download</a>
            </span>
        ...
        <!-- Personal Info -->
        <div
          class="bg-gray-50 p-6 rounded-xl shadow-sm md:col-span-2 relative transition-transform duration-500 hover:scale-[1.02]"
        ...
        <div
          ...
          <form @submit.prevent="saveProfile" class="space-y-4">
            ...
            <div class="flex justify-end gap-4 mt-4">
              ...
              <button type="submit"
                class="px-6 py-2 bg-orange-500 text-white rounded-xl hover:bg-orange-600 transition">Save</button>
            </div>
          </form>
        </div>
      </div>
...
const editSection = (section) => {
  ...
  currentSectionName.value = section === 'professional' ? 'Professional Info' : section === 'salary' ? 'Salary & Portfolio' : 'Personal Info'
...
const saveProfile = () => {
  authStore.updateProfile(editUser)
